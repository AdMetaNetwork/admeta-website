...
const SupportItems: FC = () => {
  return (
    <div className='w-full px-space-100 3xl:px-space-200 box-border flex justify-between items-start mb-space-150 translate-y-10'>
      <div
      ...
      >
        ...
        <div className='text-gray-c100 text-sm text-p-light'>Block trackers used by websites to collect data on user
          behavior
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className='text-gray-c100 text-sm text-p-light'>Detect and protect against phishing and malicious
          websites
          that can compromise user browsing security
        </div>
      </div>
      <div
        className='flex flex-col items-start w-space-140'
      >
        ...
        <div className='text-gray-c100 text-sm text-p-light'>Phishing and security checks for DApp front-end sites
        </div>
      </div>
      <div
        className='flex flex-col items-start w-space-140'
      >
        ...
        <div className='text-gray-c100 text-sm text-p-light'>Automatically rejects non-essential cookies and
          eliminates
