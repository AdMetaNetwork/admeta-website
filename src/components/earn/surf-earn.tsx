      ...
      <AnimatePresence>
        ...
        >
          <div className='flex flex-col items-start w-space-160 mb-12'>
            ...
            <div className='text-gray-c100 text-sm text-p-light'>Users who opt-in to our ad service will receive
              personalized ads and can earn rewards in return
            </div>
          </div>
        </motion.div>
      </AnimatePresence>
      <AnimatePresence>
        ...
        >
          <div className='flex flex-col items-start w-space-160 mb-12'
               id={'surf-earn'}>
            <EarnSvg2/>
            <div className='my-2 text-white-c100 text-lg text-p-semi-bold s-items-before'>NFT and SBT loyalty program
            </div>
            <div className='text-gray-c100 text-sm text-p-light'>AdMeta provides NFTs and SBTs to our loyal users,
              granting
              them exclusive privileges such as airdrops and other rewards.
            </div>
          </div>
        </motion.div>
      </AnimatePresence>
