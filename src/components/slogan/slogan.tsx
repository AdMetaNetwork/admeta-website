...
const Slogan: FC = () => {
  return (
    <div className='w-full px-space-100 3xl:px-space-200 box-border'>
      ...
      <div className='text-white-c000 text-base leading-6 mb-10 text-p-light'>AdMeta is a Web3 advertising protocol, completely<br/> designed and customized for Web3 and Metaverse.</div>
      <Btn
        label={'Start Now'}
        handleClick={() => {
